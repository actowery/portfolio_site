...
$WikiTitle = 'toweryci Wiki';

$ScriptUrl = 'https://web.engr.oregonstate.edu/~toweryci/wiki';
$PubDirUrl = 'https://web.engr.oregonstate.edu/~toweryci/wiki/pub';
...
session_name('toweryciWikiSESSID');
...
$DefaultPasswords['admin'] = 'id:toweryci';
$DefaultPasswords['upload'] = 'id:toweryci';
$DefaultPasswords['edit'] = 'id:toweryci';
// $DefaultPasswords['read'] = 'id:toweryci';
